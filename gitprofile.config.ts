...
const CONFIG = {
      ...
      projects: [
        {
          ...
          link: 'https://drive.google.com/file/d/1Ue5gqVh2AsJA-scdcqVMPW2fPnReJvQS/view?usp=sharing',
        },
        {
          title: 'OpenCart', //4
          description:
  ...
  resume: {
    fileUrl:
      'https://drive.google.com/file/d/1h9tYlSWFV6swRilCaJ26y5mfHJdFC8oq/view?usp=drive_link', // Empty fileUrl will hide the `Download Resume` button.
  },
  skills: [
    'React',
    'Kotlin',
